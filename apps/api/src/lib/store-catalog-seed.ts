/** The hardware catalogue the store started with. Used once, to fill an empty store_products
 *  table (see ensureStoreCatalog in routes/products.ts); after that the database is the source of
 *  truth and super admins edit it from the dashboard. Prices here are whole shillings. The old
 *  rating/reviewCount fields are ignored: there was never a review system behind them. */
...
export const STORE_SEED_PRODUCTS: SeedProduct[] = [
  // 1. Routers & ONUs
  {
