    ...
    <Card className="p-6 lg:p-8 space-y-6 border-slate-800 bg-slate-950/90 shadow-lg font-sans text-left">
      ...
      {printMode === "pos" ? (
        ...
        <div className="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-900/50 border border-slate-800">
          <div className="w-[280px] bg-white text-black p-5 rounded-md shadow-lg font-mono text-xs text-center border border-dashed border-slate-300 print:w-full print:m-0 print:border-none">
            <div className="font-semibold text-sm uppercase tracking-wider">{brandName}</div>
            ...
            <div className="my-3 p-3 bg-gray-50 border border-gray-300 rounded text-center">
              ...
              <div className="text-xl font-bold tracking-widest text-black mt-1">
                {SAMPLE_BATCH[2]?.pin}
              </div>
            </div>
          ...
          {SAMPLE_BATCH.map((v, i) => (
            <div key={i} className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-2 text-left font-mono">
              <div className="flex justify-between items-start">
                ...
                <span className="text-xs font-bold text-emerald-400">{v.price}</span>
              </div>
              <div className="p-2 rounded bg-slate-950 text-center border border-slate-800">
                ...
                <div className="text-base font-bold text-white tracking-widest">{v.pin}</div>
              </div>
