  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        ...(has("customers.read") ? [{ href: "/customers/leads", label: "Signup requests", icon: "user-plus", keywords: "leads coverage new customers connect installation request" } as NavItem] : []),
